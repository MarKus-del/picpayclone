...
import br.com.markusdel.picpayclone.conversor.UsuarioConversor;
import br.com.markusdel.picpayclone.dto.UsuarioDTO;
import br.com.markusdel.picpayclone.exceptions.NegocioException;
...
public class UsuarioService implements IUsuarioService {
    ...
    public void validar(Usuario... usuarios) {
        Arrays.asList(usuarios).stream().forEach(usuario -> {
            if(usuario == null){
                throw new NegocioException("o usuario informado não existe");
            }
        });
    }
